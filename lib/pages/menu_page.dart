          ...
          Column(
            children: [
              ListTile(
                ...
                title:
                    Text((correo).toString(), style: TextStyle(fontSize: 16)),
              ...
              ListTile(
                ...
                onTap: () {
                  ...
                  Navigator.pushReplacement(context,
                      MaterialPageRoute(builder: (context) => PoiPage()));
                },
              ),
              ListTile(
                leading: const Icon(
              ...
              ListTile(
                ...
                title: const Text("Piramides de Egipto",
                    style: TextStyle(fontSize: 20)),
                textColor: Colors.indigo,
                onTap: () {
                  FirebaseAuth.instance.signOut();
  ...
  Widget build(BuildContext context) {
    return BottomNavigationBar(
      ...
      onTap: (indice) {
        if (indice == 0) {
          Navigator.push(
              context, MaterialPageRoute(builder: (contetx) => MenuPage()));
        } else if (indice == 1) {
          Navigator.push(
              context, MaterialPageRoute(builder: (contetx) => PoiPage()));
        } else {
          Navigator.push(
              context, MaterialPageRoute(builder: (contetx) => MenuPage()));
        }
